...
# <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCO_NvDDs6yqtWOiQS4ZFHWJquK_jjh2pM&libraries=places,geometry" type="text/javascript"></script>
...
# <script src="/js/bootstrap-datepicker.bg.js" type="text/javascript"></script>
